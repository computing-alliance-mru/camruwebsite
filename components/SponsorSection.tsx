...
export default function SponsorSection({ sponsor }: { sponsor: sponsorContent }) {
  ...
  return (
    <section id="sponsors" className="container mx-auto p-8 px-4 md:px-8 max-w-screen-xl">
      ...
      <div className="hidden md:grid grid-cols-1 md:grid-cols-1 gap-4 justify-center items-center mb-4">
        {sponsor.map((member) => (
          <SponsorCard
            key={member.slug}
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="text-lg font-plex leading-8 text-center md:text-left">CAMRU&apos;s success is made possible by the incredible support of our sponsors.</p>
        <a href="/CAMRU_Sponsorship_and_Info_Package.pdf" target="_blank" rel="noopener noreferrer" className="leading-4 py-4 px-10 rounded-md bg-[#7289da] hover:bg-[#677bc4] text-white font-semibold cursor-pointer flex flex-row align-middle justify-center transition-all mt-8">
        Become a Sponsor!
        </a>
        </div>
    </section>
